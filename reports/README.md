...
- [ ] Consider running a hyperparameter optimization sweep (M14) - skipped, accuracy already ~98%
- [x] Use PyTorch-lightning (if applicable) to reduce the amount of boilerplate in your code (M15) - Poul
...
- [x] Get some continuous integration running on the GitHub repository (M17) - Melina
- [x] Add caching and multi-os/python/pytorch testing to your continuous integration (M17) - Melina
...
- [x] Create a more specialized ML-deployment API using either ONNX or BentoML, or both (M25) - Melina/Kaja
